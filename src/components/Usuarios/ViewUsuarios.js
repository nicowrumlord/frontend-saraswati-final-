                ...
                <div className="overflow-x-auto relative shadow-md sm:rounded-lg flex-1">
                        ...
                        <table className="table table-bordered rounded-md w-full text-md  ">
                            ...
                            <tbody className="bg-sky-200 border-b">
                                {usuario.map(item => (
                                    <tr>
                                        <td scope="row" className="py-4 px-6 font-medium text-gray-900 text-center whitespace-nowrap dark:text-white">{item.nombre}</td>
                                        <td scope="row" className="py-4 px-6 font-medium text-gray-900 text-center whitespace-nowrap dark:text-white">{item.email}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
