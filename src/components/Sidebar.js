        ...
        <aside className=" lg:w-80 rounded bg-sky-100" aria-label="Sidebar">
            <div className="overflow-y-auto py-4 px-3 rounded bg-sky-100">
                <ul className='space-y-2'>
                    ...
                    <li>
                        <a href="/admin" class="flex items-center p-2 text-base font-bold  text-stone-900 rounded-lg dark:text-white hover:bg-red-500 dark:hover:bg-red-500">
                    ...
                    <li>
                        <a href='/crearCategoria' class="flex items-center p-2 text-base font-bold text-stone-900 rounded-lg dark:text-white hover:bg-red-500 dark:hover:bg-red-500">
                    ...
                    <li>
                        <a href='/listaCategorias' class="flex items-center p-2 text-base font-bold text-stone-900 rounded-lg dark:text-white hover:bg-red-500 dark:hover:bg-red-500">
                    ...
                    <li>
                        <a href="/searchProductos" className="flex items-center p-2 text-base font-bold text-stone-900 rounded-lg dark:text-white hover:bg-red-500 dark:hover:bg-red-500" >
                            <svg aria-hidden="true" class="flex-shrink-0 w-6 h-6 text-stone-900 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 2a4 4 0 00-4 4v1H5a1 1 0 00-.994.89l-1 9A1 1 0 004 18h12a1 1 0 00.994-1.11l-1-9A1 1 0 0015 7h-1V6a4 4 0 00-4-4zm2 5V6a2 2 0 10-4 0v1h4zm-6 3a1 1 0 112 0 1 1 0 01-2 0zm7-1a1 1 0 100 2 1 1 0 000-2z" clip-rule="evenodd"></path></svg>
                            <span className="ml-3 whitespace-nowrap"> Products </span>
                        </a>
                    </li>
                    <li>
                        <a href="/usuarios" className="flex items-center p-2 text-base font-bold text-stone-900 rounded-lg dark:text-white hover:bg-red-500 dark:hover:bg-red-500">
